...
var createAdmin = function () { return __awaiter(void 0, void 0, void 0, function () {
    var userSchema, User, salt, hashedPassword, admin, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, 6, 8]);
                return [4 /*yield*/, mongoose_1.default.connect('mongodb+srv://jhulee1:Omoiyaeyo1@cluster0.da7b5xz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0')];
            case 1:
                _a.sent();
